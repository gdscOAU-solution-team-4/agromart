...
export default function SignIn() {
  ...
  return (
    <>
        <AuthLayout buttonContent={"Sign In"} subHeading={"Pick up where you left"} authImg={loginImg} handleLink={"/"} quesion={"Don’t have an account?"} questionLinkText={" Create One"} questionLink={"/register"}>

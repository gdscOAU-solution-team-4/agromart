...
export default function Cta() {
  return (
    <section className='my-28 px-1 md:px-0 lg:px-5'>
      <div className='flex flex-col items-center rounded-[2.5rem] bg-[#0E563F] px-7 py-8 md:px-4 lg:items-start lg:px-20'>
        <h3 className='text-center font-roboto text-[3.125rem] font-semibold leading-none text-white md:text-start md:text-[1.5rem]'>
          Get Affordable Agricultural Products Easily
        </h3>
        <p className='my-7 mx-auto max-w-[70%] text-center font-dmSan text-sm text-white md:mx-0 md:text-start md:text-xl'>

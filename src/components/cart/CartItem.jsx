...
export default function CartItem({ imgUrl, name, category, price }) {
  return (
    <Card className='my-7 flex items-center justify-between gap-10 bg-white shadow-[12px_26px_50px_rgba(90,108,234,0.07)]'>
      ...
      <button className='group inline-block cursor-pointer rounded-[.625rem] border-[.625rem] border-transparent bg-green-100 p-2 text-center transition-colors duration-200 ease-linear hover:bg-inherit hover:outline hover:outline-green-100'>

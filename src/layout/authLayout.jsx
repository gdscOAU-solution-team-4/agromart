...
const AuthLayout = ({heading,subHeading,children, authImg, handleLink, buttonContent, quesion, questionLink, questionLinkText}) => {
  return (
    <Fragment>
      <Navbar />
      ...
      <div className="">
        ...
        <div className='pt-8 text-sm font-dmSan font-500 text-[#141414] text-center '>
          {quesion} <span>
            <Link to={questionLink} className="text-[#0E563F]">{questionLinkText}</Link>
          </span>
        </div>
      </div>
